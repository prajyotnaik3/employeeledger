...
public class EmployeeController {
	...
	public @ResponseBody String addEmployee(@RequestParam Employee employee) {
	...
	//curl -s -H "Content-Type: application/json;accept: application/json" -d "{\"employeeCode\":104,\"name\":\"John White\",\"designation\":\"Web Developer\"}" http://localhost:8080/addEmployee/
